...
Hello I am Mitali Joshi. I am a 2nd Year MHS student in the Epidemiology department at the Bloomberg School of Public Health in the Genetics track. What makes me special is  I believe my research interest of cancer genetics and gene environment interactions are my passions and part of my brand as an epidemiologist.

What is stand for is environmental justice and health equality. All people should get the same equal health treatment and opportunities regardless of their gender, sex, race or other social constructs meant to divide as individuals. 

My audience is all people interested in genetics, the environment and epidemiology. I would like to hope that I am a good resource about learning more about either of those three topics.

My goal as a genetic epidemiologist and researcher is to find more targeted therapies from individuals that are inflicted with cancer or other genetic conditions that are largely impacted by the environment. Identifying and implementing strategies to treat and reduce certain exposures.
...
- **Link to your GitHub repository**: [https://github.com/mjoshi001/biostat777-intro-mitali-joshi]
...
```{bash}
awk -F, 'NR > 1 { sum += $5 } END { if (NR > 1) print sum / (NR - 1) }' students.csv
